...
namespace aw_hecsa
{
    ...
    {
        private static Guid guid_idusuario, guid_idempresa;
        ...
        protected void lbtn_acceso_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                using (db_hecsaEntities m_usuariof = new db_hecsaEntities())
                {
        ...
        public bool valida_inicio()
        {
            ...
            using (db_hecsaEntities edm_usuarios = new db_hecsaEntities())
            {
            ...
            using (db_hecsaEntities edm_empresa = new db_hecsaEntities())
            {
